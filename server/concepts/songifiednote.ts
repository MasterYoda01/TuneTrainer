...
export default class SongifiedNoteConcept {
  public readonly users = new DocCollection<SongifiedNoteDoc>("songifiednote");

  // async generateSongifiedNote(rawNote: string, songTemplate: string, author: ObjectId) {
  //   const generatedLyrics = await
  // }
